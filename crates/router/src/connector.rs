...
pub use hyperswitch_connectors::connectors::{
    ...
    paysafe::Paysafe, paystack, paystack::Paystack, paytm, paytm::Paytm, payu, payu::Payu, payway,
    payway::Payway, peachpayments, peachpayments::Peachpayments, phonepe, phonepe::Phonepe,
